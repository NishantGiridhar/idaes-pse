...
:ref:`ControlVolume1D Blocks <reference_guides/core/control_volume_1d:1D Control Volume Class>`
...
:ref:`Vapor Phase Property Methods <reference_guides/model_libraries/power_generation/carbon_capture/mea_solvent_system/properties/vapor_prop:Vapor Phase Property Methods>` while the ``liquid_phase``
ControlVolume1D Block block uses the :ref:`Liquid Phase Property Methods <reference_guides/model_libraries/power_generation/carbon_capture/mea_solvent_system/properties/liquid_prop:Liquid Phase Property Methods>`. Both property packages are built
off of the :ref:`Physical Property Package Class <reference_guides/core/physical_property_class:Physical Property Package Classes>`.
...
by the :ref:`ControlVolume1D Blocks <reference_guides/core/control_volume_1d:1D Control Volume Class>`
